...
public class LibraryManager {
    ...
    public void fill() {
        ...
        save(new Book(3L, "Zmierzch", "Stephenie Meyer", "Zmierzch", State.Wypożyczona, Genre.Romans));
        save(new Book(4L, "Pustynna włócznia I", "Peter U. Brett", "Cykl Demoniczny", State.Wypożyczona, Genre.Fantastyka));
        ...
        save(new Book(8L, "Zaćmienie", "Stephenie Meyer", "Zmierzch", State.Wypożyczona, Genre.Romans));
        ...
        save(new Book(11L, "Tron z czaszek II", "Peter U. Brett", "Cykl Demoniczny", State.Wypożyczona, Genre.Fantastyka));
